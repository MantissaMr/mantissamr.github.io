  ...
  create  table "climate_trace"."prod"."cement_emissions_with_confidence__dbt_tmp"
  
  
    as
  
  (
    -- models/cement_emissions_with_confidence.sql
WITH cement_emissions AS (
    SELECT
        source_id,
        source_name,
        source_type,
...
cement_confidence AS (
    SELECT
        ...
        created_date,
        modified_date
    FROM "climate_trace"."prod"."stg_cement_emissions_sources_confidence"
